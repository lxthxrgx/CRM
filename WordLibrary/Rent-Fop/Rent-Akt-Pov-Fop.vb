...
Public Class Rent_Akt_Pov_Fop
    Private Const MaxRetryAttempts As Integer = 5
    Private Const RetryDelayMilliseconds As Integer = 500S
    ...
    Public Shared Function AddTextToContentControl(docPath As String,
        ...
        Console.WriteLine("edruofop_Data: " & edruofop_Data)
